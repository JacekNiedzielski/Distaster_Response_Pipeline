...
def load_data(messages_filepath, categories_filepath):
    """
    This function loads the necessery data for supervised learining and stores
    this data in the pandas data frame
    ...
    Returns
    -------
    df : -> data frame consisting of data included in the abovementioned
    csv files
...
def save_data(df, database_filename):
    """
    This function takes as parameters the data frame and filename under the
    which the database shall be saved
