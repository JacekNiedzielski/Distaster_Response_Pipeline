...
def index():
    """
    This function displays the visuals at the main page. Takes no parameters,
    everything is defined explicitly within the function.
    """
    #Genre counts:
...
def go():
    """
    This function displays the categories which machine learning model found
    applicable to the query typed by the application user at the main
    page
    """
